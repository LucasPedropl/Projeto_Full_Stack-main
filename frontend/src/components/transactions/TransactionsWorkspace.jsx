...
export default function TransactionsWorkspace({ type }) {
	...
	const applySearch = isExpense
		? expenseCtx.applySearch
		: incomeCtx.applySearch;
	const clearSearch = isExpense
		? expenseCtx.clearSearch
		: incomeCtx.clearSearch;
	const removeItem = isExpense
		? expenseCtx.removeExpense
		: incomeCtx.removeIncome;
